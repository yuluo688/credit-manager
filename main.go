...
import (
	...
	"github.com/yuluo688/credit-manager/internal/plugin"
...
func hostCall(method string, payload []byte) ([]byte, int, error) {
	...
	if len(payload) > 0 {
		...
		if cPayload == nil {
			return nil, 0, fmt.Errorf("allocate host callback %s", method)
		}
